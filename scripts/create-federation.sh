...
echo "Waiting for the Federation Control Plane to initialize (240 seconds)"
sleep 240
...
# Add kubeconfig to secret
kubectl create secret generic kubeconfig-federation --from-file=$HOME/.kube/config